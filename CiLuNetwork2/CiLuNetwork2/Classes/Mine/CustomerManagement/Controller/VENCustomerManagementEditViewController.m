//
//  VENCustomerManagementEditViewController.m
//  CiLuNetwork2
//
...
@interface VENCustomerManagementEditViewController () <UITableViewDelegate, UITableViewDataSource, UITextViewDelegate>
...
@implementation VENCustomerManagementEditViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.navigationItem.title = self.isEdit ? @"编辑客户" : @"添加客户";
...
- (void)setupTableView {
    ...
    // 保存
    UIView *footerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kMainScreenWidth, 25 + 48)];
    tableView.tableFooterView = footerView;
    
    UIButton *saveButton = [[UIButton alloc] initWithFrame:CGRectMake(15, 25, kMainScreenWidth - 30, 48)];
...
- (void)saveButtonClick {
    ...
    [[VENNetworkTool sharedManager] requestWithMethod:HTTPMethodPost path:self.isEdit ? @"keyAccount/editCustomer" : @"keyAccount/addCustomer" params:params showLoading:YES successBlock:^(id response) {
